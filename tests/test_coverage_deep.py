...
class TestOAuth2Deep:
    ...
    async def test_token_endpoint_returns_non_200(self) -> None:
        ...
        with patch("efactgate_sdk.auth.oauth2.httpx.AsyncClient") as mock_cls:
...
class TestSerializationDeep:
    ...
    def test_deserialize_non_object_root(self) -> None:
        ...
        from efactgate_sdk.models.invoice import FluxCreatedResponse
    ...
    def test_decode_int_with_bool_raises(self) -> None:
        ...
        from efactgate_sdk.models.invoice import BatchResponse
        from efactgate_sdk.transport.serialization import deserialize
